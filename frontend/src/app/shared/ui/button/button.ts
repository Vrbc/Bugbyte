...
const VARIANT_CLASSES: Record<ButtonVariant, string> = {
  primary:
    'bg-linear-to-br cursor-pointer from-cyan to-purple text-white hover:-translate-y-0.5 hover:shadow-[0_4px_15px_rgba(56,189,248,0.3)]',
  secondary:
    'bg-transparent cursor-pointer border border-border text-on-background hover:-translate-y-0.5 hover:border-cyan hover:shadow-[0_0_10px_rgba(56,189,248,0.1)]',
  ghost: 'bg-transparent cursor-pointer text-on-surface-variant hover:text-on-background',
  danger:
